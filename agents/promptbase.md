...
Visit the official resource: [https://github.com/microsoft/promptbase](https://github.com/microsoft/promptbase)
...
```bash
git clone https://github.com/microsoft/promptbase
cd promptbase
