...
Visit the official resource: [https://github.com/lesfurets/git-octopus](https://github.com/lesfurets/git-octopus)
...
```bash
git clone https://github.com/lesfurets/git-octopus
cd git-octopus
...
- Official Link: [https://github.com/lesfurets/git-octopus](https://github.com/lesfurets/git-octopus)
